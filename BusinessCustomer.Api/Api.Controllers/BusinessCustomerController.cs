using BusinessCustomer.Api.Extensions;
using BusinessCustomer.Api.ViewModels;
using BusinessCustomer.Domain;
using BusinessCustomer.Domain.Erros;
using BusinessCustomer.Domain.Exceptions;
...
namespace BusinessCustomer.Api.Api.Controllers
{
    /// <summary>
    ...
    {
        private readonly IBusinessApi _service;
        ...
        public BusinessCustomerController(IBusinessApi service, ILogger<BusinessCustomerController> logger, IParametersHandler handler)
        {
